...
parser.add_argument('--if_Regularzation',type=bool, default=False, help='whether regularzation')
...
parser.add_argument('--loss', type=str, default='mse', help='loss function')#损失函数可以换
