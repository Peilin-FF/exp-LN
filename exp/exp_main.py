...
from models import MambaFormer, AttMam, MamAtt, Mamba, DecoderOnly,Mamba2_RMS,Mamba2_BN,Mamba2_LN,Mamba2_GN,Mamba2_IN
...
class Exp_Main(Exp_Basic):
    ...
    def _build_model(self):
        ...
        wandb.init(project="Mamba2_LN",name=self.args.runname,entity="peilin-ff-beihang-university")
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
                iter_count += 1
                model_optim.zero_grad()#初始化模型，不让其对下一次产生影响
                batch_x = batch_x.float().to(self.device)
                batch_y = batch_y.float().to(self.device)
    ...
    def test(self, setting, test=0):
        ...
        #np.save(folder_path + 'pred.npy', preds)  #最后绘图用
